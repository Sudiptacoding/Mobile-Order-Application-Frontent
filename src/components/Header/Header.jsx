...
const Header = () => {
    ...
    return (
        <div>
            <Headroom>
                <header className=" flex flex-wrap w-full py-3 text-sm backdrop-blur-sm bg-black sm:justify-start sm:flex-nowrap sm:py-0 ">
                    <nav className="relative w-full px-4 mx-auto max-w-7xl sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
                        <div className="flex items-center justify-between">
                            <Link to='/' className="flex-none text-xl font-semibold dark:text-white text-white" aria-label="Brand">OrderNexa </Link>
                            ...
                            <div className="flex flex-col mt-5 gap-y-4 gap-x-0 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-[26.75rem]">
                                <NavLink
                                    className={({ isActive, isPending }) =>
                                        isPending ? "pending" : isActive ? "font-medium text-blue-600 sm:py-6 dark:text-white" : "font-medium text-white sm:py-6 dark:text-blue-500"
                                    }
...

                                {
                                    data?.admin && <div className="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
                                        <button type="button" className="flex items-center w-full font-medium text-white hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 ">
                                            Dashboard
                                        ...
                                        <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 sm:w-48 hidden z-10 bg-white sm:shadow-md rounded-lg p-2 dark:bg-gray-800 sm:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full sm:border before:-top-5 before:left-0 before:w-full before:h-5">
                                            ...
                                            <NavLink to='/allphonelist' className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" >
                                                List of all Phone
                                            </NavLink>
                                ...
                                <div className="flex items-center justify-center cursor-pointer gap-x-5 sm:ml-auto">
                                    <a data-hs-overlay="#hs-overlay-top" className="flex items-center font-medium text-white gap-x-2 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500" >
                                    ...
                                    <a className="flex items-center font-medium text-white cursor-pointer gap-x-2 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500" >
                                        <DarkMood></DarkMood>
                                    </a>
